        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kateg_mobil" id=""
                        value="{{ $armada->kateg_mobil }}" class="form-control" disabled>
                </div>
                <div class="form-group">
                    <label for="kecepatan_kosong">Kecepatan Kosong</label>
                    <input type="text" name="kecepatan_kosong" id=""
                        value="{{ $armada->kecepatan_kosong }}" class="form-control" disabled>
                </div>
                <div class="form-group">
                    <label for="kecepatan_muatan">Kecepatan Muatan</label>
                    <input type="text" name="kecepatan_muatan" id=""
                        value="{{ $armada->kecepatan_muatan }}" class="form-control" disabled>
                </div>
                <div class="form-group">
